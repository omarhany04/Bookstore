...
export default function BookCover({ title, subtitle, category, className = "" }) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-x-4 bottom-4 rounded-[1.35rem] border border-white/16 bg-black/18 px-4 py-4 backdrop-blur-md">
